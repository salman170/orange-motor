      ...
      <div className="mx-7 md:mx-4 lg:mx-7 xl:mx-4">
        ...
        <div className="grid grid-cols-3 gap-2 py-3 text-sm capitalize text-gray-800/80">
          <div className="flex flex-col justify-center">
            <p className="text-secondary">{dimensions[0].title}</p>
            <p>{dimensions[0].value}</p>
          </div>
          <div className="flex flex-col justify-center">
            <p className="text-secondary">{dimensions[1].title}</p>
            <p>{dimensions[1].value}</p>
          </div>
          <div className="flex flex-col justify-center">
            <p className="text-secondary">{dimensions[2].title}</p>
            <p>{dimensions[2].value}</p>
          </div>
          <div className="flex flex-col justify-center">
            <p className="text-secondary">{dimensions[3].title}</p>
            <p>{dimensions[3].value}</p>
          </div>
          <div className="flex flex-col justify-center">
            <p className="text-secondary">{dimensions[4].title}</p>
            <p>{dimensions[4].value}</p>
          </div>
          <div className="flex flex-col justify-center">
            <p className="text-secondary">{dimensions[5].title}</p>
            <p>{dimensions[5].value}</p>
          </div>
        </div>
